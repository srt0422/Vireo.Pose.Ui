...
import { Text, View, Button, Card, CardItem } from "native-base";
...
export function renderer() {
    ...
    return (<View>
      <Button rounded onPress={setModalVisible.bind(this, true)} iconRight>
      ...
      <Modal visible={this.state.showModal}>
        ...
        return (<CardItem key={key} button onPress={() => {
