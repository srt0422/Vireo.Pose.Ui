...
export function renderer(props, state) {
    return (<div className={this.props.wrapperClass}>
              ...
              <div className={this.props.styles[`form-group`]}>
                  ...
                  <input onChange={(e) => this.props.onContentChange(e.target.value)} type={this.props.type} className={`${this.props.styles["pose-share-content"]} ${this.props.styles["form-control"]}`} aria-label=""/>
